...
export default function RegisterPage() {
  ...
  const leftPanel = (
    <div className="hidden lg:flex lg:w-1/2 bg-zinc-950 flex-col p-14 relative overflow-hidden">
      ...
      />
      <div className="absolute top-0 right-0 w-80 h-80 bg-white/4 rounded-full blur-3xl translate-x-1/2 -translate-y-1/2 pointer-events-none" />
      <div className="relative z-10 flex flex-col h-full">
        ...
        <div className="my-auto space-y-6">
          <blockquote className="text-4xl font-display leading-tight text-white">
            &ldquo;Minutlar ichida
            <br />
            <em className="italic text-zinc-400">professional</em>
            <br />
            backend.&rdquo;
          </blockquote>
          <p className="text-zinc-500 text-sm max-w-xs leading-relaxed">
            Tenant yarating, ma&apos;lumotlar bazasini sozlang va API orqali
            ishlang — hamma narsa tayyor.
          </p>
        </div>
        <div className="flex gap-8 pt-8 border-t border-zinc-800/80">
          {[
        ...
        <div className="w-full max-w-sm space-y-7">
          ...
          <div>
            ...
            <p className="text-zinc-500 text-sm mt-1.5">
              Loyihangizni bir daqiqada boshlang
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div className="space-y-1.5">
              <label className="auth-label">
                LOYIHA NOMI <span className="text-red-400">*</span>
              </label>
              <input
                type="text"
            ...
            {error && (
              <div className="bg-red-50 border border-red-200 rounded-lg px-4 py-3 text-red-600 text-sm">
                ...
                {error.includes("allaqachon") && (
                  <Link
                    href="/auth/login"
                    className="block mt-1 underline text-red-500 hover:text-red-700"
                  >
